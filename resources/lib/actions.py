...
_actions = [
  ...
  ["Playback", [
    ...
    "playercontrol(repeat)"   , tr(30321),
    "playercontrol(repeatone)", tr(30322),
    "playercontrol(repeatall)", tr(30323),
    "playercontrol(repeatoff)", tr(30324),
    "playercontrol(random)"   , tr(30325),
    "playercontrol(randomon)" , tr(30326),
    "playercontrol(randomoff)", tr(30327),
    "playercontrol(tempoup)"  , tr(30328),
    "playercontrol(tempodown)", tr(30329),
...
_activate_window = [
  "settings"                        , tr(31200),
  "picturessettings"                , tr(31201),
  "programssettings"                , tr(31202),
  "weathersettings"                 , tr(31203),
  "musicsettings"                   , tr(31204),
  "systemsettings"                  , tr(31205),
  "videossettings"                  , tr(31206),
  "servicesettings"                 , tr(31207),
  "appearancesettings"              , tr(31208),
  "pvrsettings"                     , tr(31209),
  "skinsettings"                    , tr(31210),
  "addonbrowser"                    , tr(31211),
  "addonsettings"                   , tr(31212),
  "profilesettings"                 , tr(31213),
  "locksettings"                    , tr(31214),
  "contentsettings"                 , tr(31215),
  "profiles"                        , tr(31216),
  "systeminfo"                      , tr(31217),
  "testpattern"                     , tr(31218),
  "screencalibration"               , tr(31219),
  "loginscreen"                     , tr(31220),
  "filebrowser"                     , tr(31221),
  "networksetup"                    , tr(31222),
  "accesspoints"                    , tr(31223),
  "mediasource"                     , tr(31224),
  "startwindow"                     , tr(31225),
  "favourites"                      , tr(31226),
  "contextmenu"                     , tr(31227),
  "peripherals"                     , tr(31228),
  "peripheralsettings"              , tr(31229),
  "mediafilter"                     , tr(31230),
  "visualisationpresetlist"         , tr(31231),
  "filestackingdialog"              , tr(31232),
  "smartplaylisteditor"             , tr(31233),
  "smartplaylistrule"               , tr(31234),
  "shutdownmenu"                    , tr(31235),
  "fullscreeninfo"                  , tr(31236),
  "subtitlesearch"                  , tr(31237),
  "weather"                         , tr(31238),
  "screensaver"                     , tr(31239),
  "pictureinfo"                     , tr(31240),
  "addoninformation"                , tr(31241),
  "musicplaylist"                   , tr(31242),
  "musicfiles"                      , tr(31243),
  "musiclibrary"                    , tr(31244),
  "musicplaylisteditor"             , tr(31245),
  "musicinformation"                , tr(31246),
  "musicoverlay"                    , tr(31247),
  "songinformation"                 , tr(31248),
  "karaoke"                         , tr(31249),
  "karaokeselector"                 , tr(31250),
  "karaokelargeselector"            , tr(31251),
  "movieinformation"                , tr(31252),
  "videofiles"                      , tr(31253),
  "videooverlay"                    , tr(31254),
  "videomenu"                       , tr(31255),
  "videoosd"                        , tr(31256),
  "videotimeseek"                   , tr(31257),
  "videobookmarks"                  , tr(31258),
  "videoplaylist"                   , tr(31259),
  "pvrguideinfo"                    , tr(31260),
  "pvrrecordinginfo"                , tr(31261),
  "pvrtimersetting"                 , tr(31262),
  "pvrgroupmanager"                 , tr(31263),
  "pvrchannelmanager"               , tr(31264),
  "pvrguidesearch"                  , tr(31265),
  "pvrchannelscan"                  , tr(31266),
  "pvrupdateprogress"               , tr(31267),
  "pvrosdchannels"                  , tr(31268),
  "pvrosdguide"                     , tr(31269),
  "pvrosddirector"                  , tr(31270),
  "pvrosdcutter"                    , tr(31271),
  "tvchannels"                      , tr(31272),
  ...
  "radiosearch"                     , tr(31281),
  "videos,movies"                   , tr(31282),
  "videos,movietitles"              , tr(31283),
  "videos,tvshows "                 , tr(31284),
  "videos,tvshowtitles "            , tr(31285),
  "videos,musicvideos"              , tr(31286),
  "videos,recentlyaddedmovies"      , tr(31287),
  "videos,recentlyaddedepisodes"    , tr(31288),
  "videos,recentlyaddedmusicvideos" , tr(31289)
]
...
_windows = [
  ...
  "pictures"                 , tr(30107),
  "pvr"                      , tr(30108),
  "filemanager"              , tr(30109),
  "pvrosdteletext"           , tr(30110),
  "virtualkeyboard"          , tr(30111),
  "playercontrols"           , tr(30112),
  "seekbar"                  , tr(30113),
  "musicosd"                 , tr(30114),
  "osdvideosettings"         , tr(30115),
  "osdaudiosettings"         , tr(30116),
  "visualisation"            , tr(30117),
  "slideshow"                , tr(30118)
]
